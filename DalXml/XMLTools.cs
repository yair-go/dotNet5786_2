...
static class XMLTools
{
    ...
    public static void SaveListToXMLSerializer<T>(List<T> list, string xmlFileName) where T : class
    {
        ...
        {
            throw new DalXMLException($"fail to create xml file: {s_xmlDir + xmlFilePath}, {ex.Message}");
        }
    }
    public static List<T> LoadListFromXMLSerializer<T>(string xmlFileName) where T : class
    {
        ...
        {
            throw new DalXMLException($"fail to load xml file: {xmlFilePath}, {ex.Message}");
        }
    }
    #endregion
    ...
    public static XElement LoadListFromXMLElement(string xmlFileName)
    {
        ...
        {
            throw new DalXMLException($"fail to load xml file: {s_xmlDir + xmlFilePath}, {ex.Message}");
        }
    }
    #endregion
